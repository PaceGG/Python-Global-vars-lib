...
def file(file_path):
    ...
    Args:
        file_path (str): The path to the file or custom name.
    """
    global user_path
...
def data(directory=os.path.dirname(__file__)):
    ...
    Args:
        directory (str): The directory to use for the 'glovar.json' file. Defaults to the directory of the package script.
    """
    global data_path
...
def set(name, value=None):
    """
    Set a global variable that link to file path. Use the 'file' function to specify the name of the file.\n
    A global variable store in the 'glovar.json' file in same directory as the caller frame file.\n
    Use the 'data' function to specify the name of the directory where the json file is stored.
...
def get(name):
    ...
    A global variable is stored in the 'glovar.json' file in the directory specified by the 'data' function. Default is caller frame directory
...
def remove(name):
    ...
    Use the 'file' function to specify the path for the current user context.\n
    A global variable is stored in the 'glovar.json' file in the directory specified by the 'data' function.
...
def peek():
    ...
    Use the 'file' function to specify the path for the current user context.\n
    Global variables are stored in the 'glovar.json' file in the directory specified by the 'data' function.
